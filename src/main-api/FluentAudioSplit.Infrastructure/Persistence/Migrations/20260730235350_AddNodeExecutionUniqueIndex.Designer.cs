...
namespace FluentAudioSplit.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730235350_AddNodeExecutionUniqueIndex")]
    partial class AddNodeExecutionUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FluentAudioSplit.Domain.Entities.NodeExecution", b =>
                {
                    ...
                    b.HasIndex("WorkflowExecutionId", "WorkflowNodeId", "Attempt")
                        .IsUnique();
            ...
            modelBuilder.Entity("FluentAudioSplit.Domain.Entities.WorkflowVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FluentAudioSplit.Domain.Entities.WorkflowExecution", b =>
                {
                    ...
                    b.HasOne("FluentAudioSplit.Domain.Entities.WorkflowVersion", "WorkflowVersion")
                        .WithMany()
