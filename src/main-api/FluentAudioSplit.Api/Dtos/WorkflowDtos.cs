...
public record WorkflowNodeDto(Guid Id, int Order, string NodeType, string ConfigJson);
...
public record CreateWorkflowNodeRequest(int Order, string NodeType, string ConfigJson);
public record UpdateWorkflowRequest(string Name, List<UpdateWorkflowNodeRequest> Nodes);
public record UpdateWorkflowNodeRequest(Guid? Id, int Order, string NodeType, string ConfigJson);
